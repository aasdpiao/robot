...
SOURCE_CODE = {
	...
	event                = add{code = 0x0013, desc = "行人系统"},
	stall                = add{code = 0x0014, desc = "摊位"},
	revert               = add{code = 0x0015, desc = "撤回摊位"},
	levelup_reward       = add{code = 0x0016, desc = "升级礼包"},
	ad_reward            = add{code = 0x0017, desc = "广告礼包"},
	gift_code            = add{code = 0x0018, desc = "礼包码"},
	pray                 = add{code = 0x0019, desc = "许愿"},
	mall                 = add{code = 0x001a, desc = "商场"},
}
